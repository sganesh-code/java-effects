...
class ReservationRecipeTest {
    ...
    void testHealthcareAppointmentScheduling() {
        ...
        clinicProcess.register("slot-123", slot).unsafeRunSync();
    ...
    void testEcommerceInventoryStockLeasing() {
        ...
        storeProcess.register("sku-widget", skuUnit).unsafeRunSync();
    ...
    void testPortsAndAdaptersRuntimeInjection() {
        ...
        customProcess.register("slot-ports", slot).unsafeRunSync();
